...
if __name__ == "__main__":
    ...
    # * dataset type
    parser.add_argument("--data_path", type=str, default="/ENEL/data/objaverse_data", required=False)
    parser.add_argument("--anno_path", type=str, default="/ENEL/data/anno_data/PointLLM_brief_description_val_200_GT.json", required=False)
